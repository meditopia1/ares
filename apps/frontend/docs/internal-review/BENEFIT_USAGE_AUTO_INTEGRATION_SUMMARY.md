...
4. **Provider claims steering note**
   - Legacy Kiro steering note was removed from active documentation.
   - Current project structure and technology references now live under `apps/frontend/docs/project/`.
