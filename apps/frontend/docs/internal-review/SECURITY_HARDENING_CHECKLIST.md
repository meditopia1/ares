...
- See the repo-specific containment breakdown in [apps/frontend/docs/internal-review/RLS_CONTAINMENT_PLAN.md](/e:/wind new/day1main/apps/frontend/docs/internal-review/RLS_CONTAINMENT_PLAN.md:1).

Repo evidence:
- [apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md](/e:/wind new/day1main/apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md:479)
- [apps/frontend/docs/internal-review/SECURITY_POSTURE_ASSESSMENT.md](/e:/wind new/day1main/apps/frontend/docs/internal-review/SECURITY_POSTURE_ASSESSMENT.md:66)
...
- [apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md](/e:/wind new/day1main/apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md:434)
...
- [apps/frontend/docs/guides/RUN_POLICY_SECTIONS_IN_SUPABASE.sql](/e:/wind new/day1main/apps/frontend/docs/guides/RUN_POLICY_SECTIONS_IN_SUPABASE.sql:22)
...
Repo evidence:
- [apps/frontend/docs/guides/setup-storage-policies.sql](/e:/wind new/day1main/apps/frontend/docs/guides/setup-storage-policies.sql:4)
...
Repo evidence:
- [apps/frontend/docs/internal-review/SECURITY_POSTURE_ASSESSMENT.md](/e:/wind new/day1main/apps/frontend/docs/internal-review/SECURITY_POSTURE_ASSESSMENT.md:66)
- [apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md](/e:/wind new/day1main/apps/frontend/docs/project/SELF_HOSTED_SUPABASE_SETUP.md:473)
