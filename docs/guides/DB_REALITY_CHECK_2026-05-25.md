...
- Marketing and feedback: `landing_pages`, `landing_page_leads`, `landing_page_visits`, `contact_interactions`, `feedback`, `feedback_comments`
...
1. `docs/guides/SUPABASE_CONNECTION_SUMMARY.md` is inaccurate.
...
2. `.kiro/steering/progress.md` overstates production completeness.
...
3. The migration guide in `docs/SELF_HOSTED_SUPABASE_SETUP.md` is infrastructure-oriented, not a verified inventory of current data.
